...
scrollSuave.reveal('.efeito-right', { duration: 1000, delay: 500, origin: 'left', distance: '50px' });
scrollSuave.reveal('.efeito-left', { duration: 1000, delay: 500, origin: 'right', distance: '50px' });
scrollSuave.reveal('.efeito-topo', { duration: 1000, delay: 500, origin: 'top', distance: '50px' });
scrollSuave.reveal('.efeito-bottom', { duration: 1000, delay: 500, origin: 'bottom', distance: '50px' });

scrollSuave.reveal('.step-1', { duration: 1000, delay: 500, distance: '50px'});
scrollSuave.reveal('.step-2', { duration: 1000, delay: 1000, distance: '50px'});
scrollSuave.reveal('.step-3', { duration: 1000, delay: 1500, distance: '50px'});
